...
//我的手册
.controller('meScListCtrl', function($rootScope,$scope,$http,getPrice, meSc,$stateParams,$ionicHistory,$ionicPopup,state,req,reqRoot,_responseData,sqLiteLoginInfo,zcInfo,tip,httpService,updateMsg,addPass) {
  $scope.amount = 0
  $scope.goSc = function(){
    $ionicPopup.confirm({
      title: '提示',
      ...
      if($scope.amount>=500){
        ...
        $http({
          ...
          data: data,
            ...
            if(data.code=='1000'){
              $rootScope.inAppBrowserRef.openUrl("http://app.you121.top/strength/show.php?action=totest&data="+data.datas.data);
